      ...
      <div className="preview__main">
        <div className="preview__section">
          ...
          <div className="preview__contact">
            ...
            <p>Phone</p>
            <p className="preview__user-info">{props.contact.phoneNumber}</p>
          </div>
          <div className="preview__contact">
            <span className="material-icons">email</span>
            <p>Email</p>
            <p className="preview__user-info">{props.contact.email}</p>
          </div>
          <div className="preview__contact">
            <span className="material-icons">home</span>
            <p>Address</p>
            <p className="preview__user-info">{props.contact.address}</p>
          </div>
        </div>
